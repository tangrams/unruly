...
var whiteList = exports.whiteList = ["filter", "style", "geometry"];
...
function mergeTrees(matchingTrees, context) {
    ...
    for (var x = 0; x < len; x++) {
        (function (x) {
            ...
            mergeObjects.apply(undefined, [style].concat(_babelHelpers.toConsumableArray(styles)));
...
var Rule = (function () {
    function Rule(name, parent, style, filter) {
        _babelHelpers.classCallCheck(this, Rule);
    ...
    _babelHelpers.prototypeProperties(Rule, null, {
        buildStyle: {
...
var RuleLeaf = exports.RuleLeaf = (function (Rule) {
    function RuleLeaf(_ref) {
        ...
        _babelHelpers.classCallCheck(this, RuleLeaf);

        _babelHelpers.get(_core.Object.getPrototypeOf(RuleLeaf.prototype), "constructor", this).call(this, name, parent, style, filter);
    }

    _babelHelpers.inherits(RuleLeaf, Rule);
...
var RuleTree = exports.RuleTree = (function (Rule) {
    function RuleTree(_ref) {
        ...
        _babelHelpers.classCallCheck(this, RuleTree);

        _babelHelpers.get(_core.Object.getPrototypeOf(RuleTree.prototype), "constructor", this).call(this, name, parent, style, filter);
        this.rules = rules || [];
    }

    _babelHelpers.inherits(RuleTree, Rule);

    _babelHelpers.prototypeProperties(RuleTree, null, {
        addRule: {
...
function isEmpty(obj) {
    return _core.Object.keys(obj).length === 0;
}
...
function calculateStyle(rule) {
    ...
    if (rule.parent) {
        ...
        styles.push.apply(styles, _babelHelpers.toConsumableArray(cs));
    }
...
function mergeObjects(newObj) {
    ...
    try {
        ...
        for (var _iterator = _core.$for.getIterator(sources), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function calculateOrder(orders) {
    ...
    try {
        for (var _iterator = _core.$for.getIterator(orders), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function parseRuleTree(name, rule, parent) {
    ...
    var _groupProps2 = _babelHelpers.slicedToArray(_groupProps, 2);
    ...
    var r = new Create(_core.Object.assign(properties, whiteListed));
